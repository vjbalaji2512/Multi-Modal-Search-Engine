...
image_mapping = {1:{"title":"Dhoni wicket keeping", "path" : "./images/1.jpg"},
                 2: {"title" : "Dhoni on the cover", "path" : "./images/2.jpg"},
                 3 : {"title" : "Dhoni - the untold story", "path" : "./images/3.jpg"},
                 4 : {"title" : "Dhoni and Kohli", "path" : "./images/4.jpg"},
...
with open('meta.pkl', 'wb') as f:
    pickle.dump([text_mapping, image_mapping, audio_mapping], f)
