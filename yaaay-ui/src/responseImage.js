...
import img2 from './pages/assets/img2.jpg';
import img3 from './pages/assets/img3.jpg';
import img4 from './pages/assets/img4.jpg';
import img5 from './pages/assets/img5.jpg';

export default {
    kind: "customsearch#image",
    url: {
    ...
    items: [
      {
        ...
        title: "Dhoni wicket keeping",
        htmlTitle:
          "\u003cb\u003eTesla\u003c/b\u003e: Electric Cars, Solar &amp; Clean Energy",
          snippet:"Mahendra Singh Dhoni (born 7 July 1981), is a former international cricketer who captained the Indian national team in limited-overs formats from 2007 to ...",
